...
export class FilterField extends Field {
    ...
    private static comparisons: Map<string, Function> = new Map<string, Function>([
        ...
        [Comparison.like, function (_type: DataType, a: string, b: string) { return new RegExp(b).test(a); }],
        [Comparison.notLike, function (_type: DataType, a: string, b: string) { return !new RegExp(b).test(a); }],
        [Comparison.contains, function (_type: DataType, a: any, b: Array<number | Date | string>) { return b.findIndex(f => f == a) >= 0; }],
